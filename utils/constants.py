UNIVARIATE_DATASET_NAMES = ['50words', 'Adiac', 'ArrowHead', 'Beef',
                            ...
                            'NonInvasiveFatalECG_Thorax2', 'OliveOil',
...
MTS_DATASET_NAMES = ['ArabicDigits', 'AUSLAN', 'CharacterTrajectories',
                     'CMUsubject16', 'ECG',
                     'JapaneseVowels', 'KickvsPunch', 'Libras', 'NetFlow',
                     'UWave', 'Wafer', 'WalkvsRun']

ITERATIONS = 1  # nb of random runs for random initializations

ARCHIVE_NAMES = ['UCR_TS_Archive_2015', 'mts_archive']

CLASSIFIERS = ['fcn', 'mlp', 'resnet', 'tlenet', 'mcnn', 'twiesn', 'encoder',
               'mcdcnn', 'cnn']
...
dataset_types = {'ElectricDevices': 'DEVICE', 'FordB': 'SENSOR',
                 ...
                 'ECG5000': 'ECG', 'SwedishLeaf': 'IMAGE',
                 'ChlorineConcentration': 'SIMULATED',
                 '50words': 'IMAGE', 'ProximalPhalanxTW': 'IMAGE',
